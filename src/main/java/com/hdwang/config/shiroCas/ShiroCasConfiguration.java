...
//    @Bean
////    public MySslFilter getSslFiler(){
////        MySslFilter sslFilter = new MySslFilter();
////        sslFilter.setPort(8081);
//////        sslFilter.set
////        return sslFilter;
////    }

        @Bean
        public SslFilter getSslFiler(){
...
//    @Bean
//    public MySslFilter getFilter(){
//        return new MySslFilter();
//    }
    ...
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, UserDao userDao){
        ...
        filterChainDefinitionMap.put(casFilterUrlPattern, "casFilter,ssl");
...
//        filterChainDefinitionMap.put("/cas","onlineSession,ssl");
        //4.登录过的不拦截
        filterChainDefinitionMap.put("/**", "user");
//        filterChainDefinitionMap.put("/home","onlineSession");
